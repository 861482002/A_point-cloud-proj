...
def config_params():
    ...
    parser.add_argument('--root', required=True, help=r'read_data/textsegment/val_data')
    ...
    parser.add_argument('--checkpoint', default='pth/test_min_loss.pth',
...
if __name__ == '__main__':
    ...
    if args.method == 'benchmark':
        dura, r_mse, r_mae, t_mse, t_mae, r_isotropic, t_isotropic = evaluate_benchmark(args, test_loader)
